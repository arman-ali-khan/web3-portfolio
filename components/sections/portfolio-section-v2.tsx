...
const projects = [
  {
    ...
    description: 'A sophisticated DeFi protocol that automatically finds the best yield opportunities across multiple platforms with $2.4M TVL.',
    ...
    githubUrl: '#',
    featured: true,
    stats: { tvl: '$2.4M', users: '1,247', apy: '24.5%' }
  },
  {
    id: 2,
    title: 'NFT Marketplace',
    description: 'A full-featured NFT marketplace with minting, trading, and auction capabilities. Over 10K NFTs minted.',
    ...
    githubUrl: '#',
    featured: true,
    stats: { nfts: '10K+', volume: '$500K', users: '2.1K' }
  },
  {
    id: 3,
    title: 'DAO Governance Platform',
    description: 'A decentralized autonomous organization platform with advanced voting mechanisms and proposal management.',
    ...
    githubUrl: '#',
    featured: false,
    stats: { proposals: '150+', voters: '850', tokens: '1M' }
  },
  {
    id: 4,
    title: 'Cross-Chain Bridge',
    description: 'A secure bridge protocol enabling asset transfers between different blockchain networks with multi-sig security.',
    ...
    githubUrl: '#',
    featured: false,
    stats: { volume: '$10M', chains: '5', txs: '25K+' }
  },
  {
    id: 5,
    title: 'Portfolio Tracker App',
    description: 'A comprehensive Web2 application for tracking cryptocurrency portfolios and DeFi positions in real-time.',
    ...
    githubUrl: '#',
    featured: false,
    stats: { users: '5K+', portfolios: '12K', apis: '20+' }
  },
  {
    id: 6,
    title: 'Gaming NFT Platform',
    description: 'A gaming-focused NFT platform with play-to-earn mechanics and in-game asset trading capabilities.',
    ...
    githubUrl: '#',
    featured: false,
    stats: { players: '3K+', assets: '15K', rewards: '$100K' }
  }
];

const categories = ['All', 'Featured', 'DeFi', 'NFT', 'DAO', 'Web2'];

export function PortfolioSectionV2() {
  ...
  return (
    <section id="portfolio" className="py-16 sm:py-20 lg:py-24 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ...
            with real-world impact and proven results.
          </p>
        </motion.div>
        ...
        >
          {categories.map((category, index) => (
            ...
            >
              ...
              >
                {category}
                {category === 'Featured' && <Star className="ml-2 h-4 w-4" />}
              </Button>
            </motion.div>
          ))}
        </motion.div>
